      ...
      for (const product of products) {
        ...
        for (const image of imagesToProcess) {
          try {
            ...
            const updateSuccess = await updateImageAltTextInShopify(admin, product.id, image.id, altText, session.shop, session.accessToken);
    ...
    try {
      ...
      for (const image of imagesToProcess) {
        try {
          ...
          // Update image in Shopify
          const updateSuccess = await updateImageAltTextInShopify(admin, productId, image.id, altText, session.shop, session.accessToken);
